SELECT lic.licensenumber LicenseNumber,
  ...
  CASE
    ...
    ELSE 'Staff'
  END) CreatedByType,
  ap.externalfilenum JobNumber,  --lmscorral.bl_application.externalfilenum
  REPLACE(jt.name, 'j_BL_', '') JobType,  --???
  ap.createddate JobCreatedDate,  --lmscorral.bl_application.createddate
  ap.completeddate JobCompletedDate,  --lmscorral.bl_application.completeddate
  (
  CASE
    ...
    THEN 'https://eclipseprod.phila.gov/phillylmsprod/int/lms/Default.aspx#presentationId=1239699&objectHandle='
      ||apl.applicationobjectid  --LMSCORRAL.BL_APPLICATIONLICENSEXREF.applicatonobjectid?
